...
module OpenapiClient
  class GetLibraryHubs200ResponseMediaContainerHubInnerMetadataInner
    ...
    def self.openapi_types
      {
        ...
        :'rating_image' => :'String',
        :'media' => :'Array<GetLibraryHubs200ResponseMediaContainerHubInnerMetadataInnerMediaInner>',
        :'genre' => :'Array<GetLibraryHubs200ResponseMediaContainerHubInnerMetadataInnerGenreInner>',
        :'country' => :'Array<GetLibraryHubs200ResponseMediaContainerHubInnerMetadataInnerCountryInner>',
        :'director' => :'Array<GetLibraryHubs200ResponseMediaContainerHubInnerMetadataInnerDirectorInner>',
        :'role' => :'Array<GetLibraryHubs200ResponseMediaContainerHubInnerMetadataInnerRoleInner>',
        :'writer' => :'Array<GetLibraryHubs200ResponseMediaContainerHubInnerMetadataInnerWriterInner>',
        :'skip_count' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GetLibraryHubs200ResponseMediaContainerHubInnerMetadataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GetLibraryHubs200ResponseMediaContainerHubInnerMetadataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [rating_key, key, guid, studio, type, title, library_section_title, library_section_id, library_section_key, content_rating, summary, rating, audience_rating, view_count, last_viewed_at, year, tagline, thumb, art, duration, originally_available_at, added_at, updated_at, audience_rating_image, primary_extra_key, rating_image, media, genre, country, director, role, writer, skip_count, chapter_source].hash
    end
