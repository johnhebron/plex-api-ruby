...
module OpenapiClient
  class GetMetadata200ResponseMediaContainerMetadataInner
    ...
    def self.openapi_types
      {
        ...
        :'rating_image' => :'String',
        :'media' => :'Array<GetMetadata200ResponseMediaContainerMetadataInnerMediaInner>',
        :'genre' => :'Array<GetMetadata200ResponseMediaContainerMetadataInnerGenreInner>',
        :'country' => :'Array<GetMetadata200ResponseMediaContainerMetadataInnerCountryInner>',
        :'guid' => :'Array<GetMetadata200ResponseMediaContainerMetadataInnerGuidInner>',
        :'rating' => :'Array<GetMetadata200ResponseMediaContainerMetadataInnerRatingInner>',
        :'director' => :'Array<GetMetadata200ResponseMediaContainerMetadataInnerDirectorInner>',
        :'writer' => :'Array<GetMetadata200ResponseMediaContainerMetadataInnerWriterInner>',
        :'role' => :'Array<GetMetadata200ResponseMediaContainerMetadataInnerRoleInner>',
        :'producer' => :'Array<GetMetadata200ResponseMediaContainerMetadataInnerProducerInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GetMetadata200ResponseMediaContainerMetadataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GetMetadata200ResponseMediaContainerMetadataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rating')
        if (value = attributes[:'rating']).is_a?(Array)
          self.rating = value
        end
      end
      ...
      if attributes.key?(:'producer')
        if (value = attributes[:'producer']).is_a?(Array)
          self.producer = value
        end
      end
    end
    ...
    def hash
      [rating_key, key, guid, studio, type, title, library_section_title, library_section_id, library_section_key, content_rating, summary, rating, audience_rating, year, tagline, thumb, art, duration, originally_available_at, added_at, updated_at, audience_rating_image, has_premium_primary_extra, rating_image, media, genre, country, guid, rating, director, writer, role, producer].hash
    end
