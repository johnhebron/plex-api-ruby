...
module OpenapiClient
  class LibrarySectionsSectionIdTagGet200ResponseMediaContainerMetadataInner
    ...
    def self.openapi_types
      {
        ...
        :'rating_image' => :'String',
        :'media' => :'Array<LibrarySectionsSectionIdTagGet200ResponseMediaContainerMetadataInnerMediaInner>',
        :'genre' => :'Array<LibrarySectionsSectionIdTagGet200ResponseMediaContainerMetadataInnerGenreInner>',
        :'country' => :'Array<GetRecentlyAdded200ResponseMediaContainerMetadataInnerCountryInner>',
        :'director' => :'Array<LibrarySectionsSectionIdTagGet200ResponseMediaContainerMetadataInnerDirectorInner>',
        :'writer' => :'Array<LibrarySectionsSectionIdTagGet200ResponseMediaContainerMetadataInnerDirectorInner>',
        :'role' => :'Array<LibrarySectionsSectionIdTagGet200ResponseMediaContainerMetadataInnerRoleInner>',
        :'title_sort' => :'String',
        :'view_count' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::LibrarySectionsSectionIdTagGet200ResponseMediaContainerMetadataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::LibrarySectionsSectionIdTagGet200ResponseMediaContainerMetadataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
